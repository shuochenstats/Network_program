...
% intialization of the kmeans++ algorithm. 
    ...
    snapnow;
    warning('off','all')
   [Test_Cindxn ,Test_CIDn ,Test_Clistn ]=Pard(squareform(WnTest0),1,0,8); 
    ...
    [signodeGEP,GEPstat,P_Pard]=GEP_newstats_testonly(WnTest,WnTest0,Test_Cindxn,Test_CIDn,100);  
